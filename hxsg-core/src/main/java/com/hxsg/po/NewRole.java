...
public class NewRole implements Serializable {
    ...
    private String heiStatus;//拉黑,解黑
    private String jinStatus;//禁言,解禁
    //玩家携带的副将
    private List<RoleFujiang> fuLi;
    //玩家技能
    private List<Skill> skill;
    //玩家抗性
    private List<RoleNewShuXing> shuxing;
    ...
    public List<RoleFujiang> getFuLi() {
        return fuLi;
    }

    public void setFuLi(List<RoleFujiang> fuLi) {
        this.fuLi = fuLi;
    }

    public String getHeiStatus() {
        return heiStatus;
    }

    public void setHeiStatus(String heiStatus) {
        this.heiStatus = heiStatus;
    }
    ...
    public void setJinStatus(String jinStatus) {
