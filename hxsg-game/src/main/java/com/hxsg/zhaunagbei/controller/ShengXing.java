...
public class ShengXing {
    ...
    @Autowired
    wuqiMapper wqm;
    public void getshengxing(Integer wuqiid,HttpServletRequest request,HttpServletResponse response)throws Exception {
       ...
       // String pinzhi =wqdm.selectAll(wqd).get(0).getPinzhi();
        Integer pinzhi =1;
        switch (levels) {
            case 1: {
