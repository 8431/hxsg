...
public class indexWebScoketController extends TextWebSocketHandler implements HandshakeInterceptor {
    ...
    private final String CHATMSG="hxsg:chatMsg:";
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) {
        try {
           ...
           // Role re = gn.fromJson(dataMap.get("role"), Role.class);
            ...
            if(roleid!=null){
                NewRole role= (NewRole) redisdaoservice.get("role:msg:"+roleid);
                    ...
                    switch (typeChat){
                        ...
                        default:{
                           ...
                           // List<roleMessage> li=rolemessagemapper.getMsgType(typeChat);
                            List<roleMessage> li= (List<roleMessage>) redisdaoservice.lrange(CHATMSG+typeChat,0L,19L);
    ...
    public void insertRoleMessqge(String typeChat, String chatMsg, String roleName, Integer id) throws Exception{
        boolean r=false;
        ...
        redisdaoservice.setLpush(CHATMSG+typeChat,rme);
        //插入最新消息
