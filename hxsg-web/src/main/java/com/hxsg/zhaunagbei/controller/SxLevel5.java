                ...
                switch (pinzhi) {
                    ...
                    case 1:{
                        ...
                        if (gl >70) {
                            ...
                            CommonUtilAjax.sendAjaxList("msg", "恭喜你装备升级为3星", request, response);
                        }else{
                            ...
                            if (level == 2) {
                                CommonUtilAjax.sendAjaxList("msg", "升级失败，但是没有降星", request, response);
                    ...
                    case 3:{
                        ...
                        if (gl > 70) {
                            ...
                            if (level == 1) {
                                ...
                                if (wadl.getFashubao() > 0) {
                                    wadl.setFashubao(wadl.getFashubao() - ZbShuXing.LEVEL2_ZSSX);
                                }
                                if (wadl.getZhiming() > 0) {
                                    wadl.setZhiming(wadl.getZhiming() - ZbShuXing.LEVEL2_ZSSX);
                                }
                    ...
                    case 4:{
                        ...
                        if (gl > 70) {
                            ...
                            if (wadl.getFashubao() > 0) {
                                wadl.setFashubao(wadl.getFashubao() + ZbShuXing.LEVEL3_JSSX);
                            }
                            if (wadl.getZhiming() > 0) {
                                wadl.setZhiming(wadl.getZhiming() +ZbShuXing.LEVEL3_JSSX);
                            }
                    ...
                    case 5:{
                        ...
                        if (gl > 70) {
                            ...
                            if (level == 1) {
                                ...
                                if (wadl.getQixue() > 0) {
                                    wadl.setQixue(wadl.getQixue() -ZbShuXing.LEVEL2_ZSSX);
                                }
                                if (wadl.getZhiming() > 0) {
                                    wadl.setZhiming(wadl.getZhiming() - ZbShuXing.LEVEL2_ZSSX);
                                }
                    ...
                    case 6:{
                        ...
                        if (gl > 70) {
                            ...
                            if (wadl.getQixue() > 0) {
                                wadl.setQixue(wadl.getQixue() + ZbShuXing.LEVEL3_JSSX);
                            }
                            if(wadl.getZhiming() > 0) {
                                wadl.setZhiming(wadl.getZhiming() + ZbShuXing.LEVEL3_JSSX);
                            }
