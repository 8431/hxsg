 ...
 <div class="roleid"><b>邮件</b></div>
  ...
  <br/> <br/>
 	...
 	<p class="yaoping"><a href="<%=basePath%>youjian/fsyj"><span class="sy">新邮包</span></a></p>
       <p class="yaoping"><a href="<%=basePath%>youjian/wdyj"><span class="sy">未读邮包</span></a></p>
       <p class="yaoping"><a href="<%=basePath%>youjian/ydyj"><span class="sy">已读邮包</span></a></p>
       <p class="yaoping"><a href="#"><span class="sy">开发中</span></a></p>
