...
width:80px;margin:30px 0px 0px 50px;background:#ff0000;color:#ffffff;font-size:20px;
 ...
 <div class="roleid"><b>驿馆</b></div>
  ...
  <br/> <br/>
  <hr/>
	<a href="#"><div class="xuangk" >寄存物品</div></a>
 		<a href="#"><div class="xuangk">提取物品</div></a>
 		<a href="#"><div class="xuangk">城市传送</div></a>
 		<a href="<%=basePath%>yg/fjls"><div class="xuangk">副将留守</div></a>
