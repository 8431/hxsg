...
<div class="kj" style="overflow-Y: auto;overflow-X:hidden;width:320px;">
 <div class="roleid"><b>广场</b></div>
  ...
  <br/> <br/>
    ...
    <p class="yaoping"><a href="#">双（1赔2）<span  id="shuangj" class="sy">压金</span></a><a href="#"><span class="sy" id="shuangy">压银</span></a></p>
           ...
           $.ajax({
               ...
               success: function(msg){
                  ...
                  $("#qishu").text(sum.ydxid);
                   ...
                   $("#sumwjj").text(totalsumjin/2);
                   $("#sumwjy").text(totalsumyin/2);
