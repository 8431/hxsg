                ...
                if(message.code==0){
                    for(var i=0;i<p.length;i++){
                        ...
                        var	a="<p style='text-indent:10px;color:#ff0000;line-height:30px;height:30px;width:100%;background:#634163'>"+
                            p[i].name+"<a href=''><span class='sy'>装备</span></a></p>";
                ...
                if(message.code==0){
                    ...
                    for(var i=0;i<p.length;i++){
                        if(p[i].yaonum>0){
                            ...
                            var	a="<p style='text-indent:10px;color:#ff0000;line-height:30px;height:30px;width:100%;background:#634163'>"+
                                p[i].yaoname+"("+p[i].yaonum+")<a href='jjunaction?id="+p[i].id+"'><span class='sy'>使用</span></a></p>";
        ...
        $.ajax({
            ...
            success: function(msg){
                ...
                if(message.code==0){
                    for(var i=0;i<p.length;i++){
                        if(p[i].num>0){
                            var	a="<p style='text-indent:10px;color:#fffdb5;line-height:30px;height:30px;width:100%;background:#634163'><a href='../jjunl/wpxq?name="+p[i].jjname+"'>"+
                                p[i].jjname+"("+p[i].num+")</a><a href='../jjunl/syjjl?id="+p[i].id+"&name="+p[i].jjname+"'><span class='sy'>使用</span></a></p>";
